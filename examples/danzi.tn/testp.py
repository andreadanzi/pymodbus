...
try:
    ...
    rr = client.read_holding_registers(starting_register,100)      
    if isinstance(rr ,ExceptionResponse):
        ...
        if rr.registers[test_reg_no] == test_value:   
            ...
            if bits_502[4] == False and bits_502[10] == True:
                ...
                rr.registers[50] += 1
                rq = client.write_registers(starting_register, rr.registers)
